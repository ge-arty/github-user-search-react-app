  ...
  return (
    ...
    >
      <div className="user-main-info">
        <img className="user-avatar" src={props.src} alt="avatar" />
        <div className="main-info">
          <h2
            style={
              theme.switch == true ? { color: "#FFFFFF" } : { color: "#2B3442" }
            }
            className="user-name"
          >
            {props.name}
          ...
          <p
            style={
              theme.switch == true ? { color: "#0079FF" } : { color: "#0079FF" }
            }
          ...
          <p
            style={
              theme.switch == true ? { color: "#FFFFFF" } : { color: "#697C9A" }
            }
            className="user-join-date"
          >
            Joined {moment(props.joinDate).utc().format("DD MMM YYYY")}
          </p>
          <p
            style={
              theme.switch == true ? { color: "#FFFFFF" } : { color: "#697C9A" }
          ...
          <div className="media-container">
            <div className="media-container-top">
              <div className="location-box">
                ...
                >
                  <path
                    ...
                    fill={theme.switch == true ? "#FFFFFF" : "#4B6A9B"}
                  />
                </svg>
                <a
                  href={
              ...
              <div className="twitter-box">
                ...
                <a
                  href={props.twitter == null ? "Not Available" : props.twitter}
                >
                  <p
                    style={
                      theme.switch == true
            ...
            <div className="media-container-bot">
              <div className="github-box">
                ...
                <a href={props.blog == "" ? "Not Available" : props.blog}>
                  <p
                    style={
                      theme.switch == true
                        ? { color: "#FFFFFF" }
              ...
              <div className="company-box">
                ...
                <a
                  href={props.company == null ? "Not Available" : props.company}
                >
                  <p
                    style={
                      theme.switch == true
                  ...
                  >
                    {props.company == null ? "Not Available" : props.company}
                  </p>
                </a>
              </div>
            </div>
